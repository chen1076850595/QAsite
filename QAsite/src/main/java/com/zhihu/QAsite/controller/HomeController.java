...
public class HomeController {
    ...
    public String userIndex(Model model, @PathVariable("userId") int userId) {
        ...
        vo.set("followerCount", followService.getFollowerCount(Entity.ENTITY_USER, userId));
       ...
       // vo.set("followCount",followService.getFollowerCount(Entity.ENTITY_QUESTION,));
        if (hostHolder.getUser() != null) {
            vo.set("followed", followService.isFollower(hostHolder.getUser().getId(), Entity.ENTITY_USER, userId));
        } else {
